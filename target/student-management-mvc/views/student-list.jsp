        ...
        <body>
            <div class="container">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    ...
                    <div>
                        <span
                            style="margin-right: 15px; font-weight: bold; color: #555;">${sessionScope.fullName}</span>
                        <a href="change-password" class="btn btn-secondary"
                            style="font-size: 14px; padding: 8px 15px; margin-right: 10px;">Change Password</a>
                        <a href="logout" class="btn btn-danger" style="font-size: 14px; padding: 8px 15px;">Logout</a>
                    </div>
                </div>
                    ...
                    <div style="margin: 20px 0; background: #f1f3f5; padding: 15px; border-radius: 5px;">
                        <form action="student" method="get" style="display: flex; align-items: center; gap: 10px;">
                            ...
                            <select name="major" style="padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
                                ...
                                <option value="Software Engineering" ${selectedMajor=='Software Engineering'
                                    ? 'selected' : '' }>
                            ...
                            <button type="submit" class="btn btn-secondary" style="padding: 8px 15px;">Apply
                                Filter</button>

                            <c:if test="${not empty selectedMajor}">
                                <a href="student?action=list"
                                    style="margin-left: 10px; color: #dc3545; text-decoration: none;">Clear Filter</a>
                            </c:if>
                        </form>
                    </div>
